...
import 'package:fyp/providers/expert.dart';
...
class chooseartist extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    List<Expert> retService = Provider.of<Experts>(context).experts;
    return Scaffold(
      appBar: AppBar(
          ...
          return Container(
            ...
            child: Container(
              ...
              child: ElevatedButton(
                child: Text(
                  retService[index].userObj.dateOfBirth,
